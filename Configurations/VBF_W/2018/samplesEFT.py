...
################################################
## DIR:
EFTPrivateDirectory = os.path.join(treeBaseDirEFTPrivate,  mcProduction , mcSteps + '__' + skim)
...
samples['WLNuJJ']  = {  'name'   : nanoGetSampleFiles(EFTPrivateDirectory,'W_EWK_dim6'),
