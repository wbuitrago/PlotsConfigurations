...
#                'folderUp' : mcDirectory+'_ElepTup',
#                'folderDown' : mcDirectory+'_ElepTdo',
#}
## nuisances['electronpt']  = {
##                 'name'  : 'CMS_scale_e_2018',
##                 'type'  : 'lnN',
...
#                'cuts': phase_spaces_tot_mu,
#                'samples': dict((skey, ['1.','1.']) for skey in mc if skey not in ['Vg', 'VgS']),
#                'folderUp' : mcDirectory+'_MupTup',
#                'folderDown' : mcDirectory+'_MupTdo',
#}
...
#                    'mapDown': js+'do',
#                    'samples': dict((skey, ['1.','1.']) for skey in mc if skey not in ['Vg', 'VgS']),
#                    'folderUp' : mcDirectory+'_JESup',
#                    'folderDown' : mcDirectory+'_JESdo',
...
#                        'samples': dict((skey, ['1.','1.']) for skey in mc if skey not in ['Vg', 'VgS']),
#                        'folderUp' : mcDirectory+'_fatjetJESup',
#                        'folderDown' : mcDirectory+'_fatjetJESdo'
#    }
...
#                'mapDown': 'JERdo',
#                'samples': dict((skey, ['1.','1.']) for skey in mc if skey not in ['Vg', 'VgS']),
#                'folderUp' : mcDirectory+'_JERup',
#                'folderDown' : mcDirectory+'_JERdo'
#}
...
#                'cuts': phase_spaces_boost, #because we are vetoing fatjets anyway in resolved category
#                'samples': dict((skey, ['1.','1.']) for skey in mc if skey not in ["Vg","VgS"]),
#                'folderUp' : mcDirectory+'_fatjetJERup',
#                'folderDown' : mcDirectory+'_fatjetJERdo',
#}
...
#                'mapDown': 'METdo', 
#                'samples': dict((skey, ['1.','1.']) for skey in mc if skey not in ['Vg', 'VgS']),
#                'folderUp' : mcDirectory+'_METup',
#                'folderDown' : mcDirectory+'_METdo',
#}
...
#    'cuts': phase_spaces_boost, #because we are vetoing fatjets anyway in resolved category
#    'samples': dict((skey, ['1.','1.']) for skey in mc if skey not in ["Vg","VgS"]),
#    'folderUp' : mcDirectory+'_fatjetJMRup',
#    'folderDown' : mcDirectory+'_fatjetJMRdo',
...
#    'folderUp' : mcDirectory+'_fatjetJMSup',
#    'folderDown' : mcDirectory+'_fatjetJMSdo',
#}
