...
samples['VZ']  = {    'name':   getSampleFiles(directory,'ZZTo2L2Nu',True)
                              ...
                              # + getSampleFiles(directory,'tZq_ll',True)
                              ,   
...
samples['VVV'] = {    'name':   getSampleFiles(directory,'ZZZ',True)
                           ...
                           #  + getSampleFiles(directory,'WWG',True)
                              ,    
                      'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,  
                  }
...
##### ggH -> WW NNLOPS
#
#samples['ggH_hww']  = {  'name'  : getSampleFiles(directory,'GluGluHToWWTo2L2Nu_M125_minloHJ_NNLOPS',True) ,  
#                         'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,  
#                      }

#### VBF H->WW

samples['qqH_hww']  = {   'name' : getSampleFiles(directory,'VBFHToWWTo2L2Nu_M125',True) ,
                         'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,  
                      }
...
samples['WpWmJJ_EWK']  = {   'name' : getSampleFiles(directory,'WpWmJJ_EWK',True) ,
                         'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,
                      }

samples['WpWmJJ_EWK_QCD_noHiggs']  = {   'name' : getSampleFiles(directory,'WpWmJJ_EWK_QCD_noHiggs',True) ,
                         'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,
                      }

samples['WpWmJJ_EWK_QCD_noTop']  = {   'name' : getSampleFiles(directory,'WpWmJJ_EWK_QCD_noTop',True) ,
                         'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,
                      }

samples['WpWmJJ_EWK_QCD_noTop_noHiggs']  = {   'name' : getSampleFiles(directory,'WpWmJJ_EWK_QCD_noTop_noHiggs',True) ,
                         'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,
                      }

samples['WpWmJJ_EWK_noTop']  = {   'name' : getSampleFiles(directory,'WpWmJJ_EWK_noTop',True) ,
                         'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,
                      }

samples['WpWmJJ_QCD_noTop']  = {   'name' : getSampleFiles(directory,'WpWmJJ_QCD_noTop',True) ,
                         'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,                      }
...
samples['ttH_hww']  = {  'name' :   getSampleFiles(directory,'ttHToNonbb_M125',True), 
                         'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,
...
if not splitHtt:
  ...
  samples['ggH_htt']  = { 'name' :   getSampleFiles(directory,'GluGluHToTauTau_M125',True) ,
                           'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,
                           'suppressNegative' :['all'],
                           'suppressNegativeNuisances' :['all'],
                        }

  samples['qqH_htt']  = { 'name' :   getSampleFiles(directory,'VBFHToTauTau_M125',True) ,
                           'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,
                           'suppressNegative' :['all'],
                           'suppressNegativeNuisances' :['all'],
                        }
  ...
  samples['ZH_htt']  = { 'name' :   getSampleFiles(directory,'HZJ_HToTauTau_M125',True) ,
                           'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,
                           'suppressNegative' :['all'],
                           'suppressNegativeNuisances' :['all'],
                        }

  samples['WH_htt']  = { 'name' :   getSampleFiles(directory,'HWplusJ_HToTauTau_M125',True)
                                  + getSampleFiles(directory,'HWminusJ_HToTauTau_M125',True),
                           'weight': XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC ,
                           'suppressNegative' :['all'],
                           'suppressNegativeNuisances' :['all'],
