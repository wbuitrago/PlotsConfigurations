...
supercut = '   Lepton_pt[0]>25 \
            ...
            && detajj > 3.5 \
            && multiJet \
            && (abs(CleanJet_eta[0])<2.5 || abs(CleanJet_eta[0])>3.2 || (Jet_puId[CleanJet_jetIdx[0]] & (1 << 0))==1) \
            && (abs(CleanJet_eta[1])<2.5 || abs(CleanJet_eta[1])>3.2 || (Jet_puId[CleanJet_jetIdx[1]] & (1 << 0))==1) \
           '
...
cuts['VBS'] = {
   'expr': 'sr',
   'categories' : {
      '2j_em_me_lowZ'   : 'mll>50 && multiJet && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13) && Zll[0] <1', 
      '2j_em_me_highZ'  : 'mll>50 && multiJet && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*13) && Zll[0] >= 1',
      '2j_ee_mm_lowZ'   : 'mll>120 && PuppiMET_pt>60 && multiJet && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11 || Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) && Zll[0] <1',
      '2j_ee_mm_highZ'  : 'mll>120 && PuppiMET_pt>60 && multiJet && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11 || Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) && Zll[0] >= 1 ',
