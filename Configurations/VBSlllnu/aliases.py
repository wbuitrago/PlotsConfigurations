...
# DNN reader WW
#dnn_reader_path = os.getenv('CMSSW_BASE') + '/src/PlotsConfigurations/Configurations/ssww/l3_2018/dnn/'
#dnn_reader_path = '/afs/cern.ch/user/e/evernazz/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/VBSlllnu'
...
#    'linesToAdd': ['.L %s/ssww/l3_2018/mischarge_sf.cc+' % configurations],
#    'class': 'misID_sf',
#    'samples': mc,
#}
# chargeflip
