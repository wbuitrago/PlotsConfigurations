...
groupPlot['{}_{}_1'.format(op[0],op[1])] = {
    ...
    'isSignal' : 2,
    'color' : ceft1,
    'samples' : ['sm','sm_lin_quad_{}'.format(op[0]),'quad_{}'.format(op[0]),'sm_lin_quad_{}'.format(op[1]),'quad_{}'.format(op[1]),'sm_lin_quad_mixed_{}_{}'.format(op[0],op[1]),'WZ_QCD','VVV','ZZ4L','TTV','tZq','Vg', 'VgS1_H', 'VgS1_L','Fake'],
    'scale' : { 
                'sm' : 1-j, 
