...
# lepton eta range
aliases['lep0eta']={
    'expr': '((abs(Alt$(Lepton_pdgId[0],-9999))==11 && abs(Alt$(Lepton_eta[0],-9999.)) <=2.4) || (abs(Alt$(Lepton_pdgId[0],-9999))==13 && abs(Alt$(Lepton_eta[0],-9999.)) <=2.5))'
}
aliases['lep1eta']={
    'expr': '((abs(Alt$(Lepton_pdgId[1],-9999))==11 && abs(Alt$(Lepton_eta[1],-9999.)) <=2.4) || (abs(Alt$(Lepton_pdgId[1],-9999))==13 && abs(Alt$(Lepton_eta[1],-9999.)) <=2.5))'
}
aliases['lep2eta']={
    'expr': '((abs(Alt$(Lepton_pdgId[2],-9999))==11 && abs(Alt$(Lepton_eta[2],-9999.)) <=2.4) || (abs(Alt$(Lepton_pdgId[2],-9999))==13 && abs(Alt$(Lepton_eta[2],-9999.)) <=2.5))'
}
aliases['lep3eta']={
    'expr': '((abs(Alt$(Lepton_pdgId[3],-9999))==11 && abs(Alt$(Lepton_eta[3],-9999.)) <=2.4) || (abs(Alt$(Lepton_pdgId[3],-9999))==13 && abs(Alt$(Lepton_eta[3],-9999.)) <=2.5))'
}
aliases['jetpt30']={
...
aliases['SFweight'] = {
    'expr': ' * '.join(['SFweight2l','XSWeight', 'METFilter_MC','LepSF2l__ele_' + eleWP + '__mu_' + muWP, 'LepWPCut','PromptGenLepMatch2l','btagSF']), #bveto_sf*lep_sf*trig_sf*mu_roc_sf
    #'expr': 'LepWPCut',
    'samples': mc
}
# variations
