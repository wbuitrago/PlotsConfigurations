...
class Genlep2pt : public multidraw::TTreeFunction {
public:
  Genlep2pt();

  char const* getName() const override { return "Genlep2pt"; }
  TTreeFunction* clone() const override { return new Genlep2pt(); }
...
Genlep2pt::evaluate(unsigned)
{
  ...
  return GenDressedLepton_pt->At(iPromptL[1]);
}

void
Genlep2pt::bindTree_(multidraw::FunctionLibrary& _library)
{
