...
aliases['bVetoL'] = {
    'expr': 'Sum$(CleanJet_pt > 20. && abs(CleanJet_eta) < 2.5 && Jet_btagDeepB[CleanJet_jetIdx] > 0.2217) == 0' #Jet_btagDeepB
}

aliases['bVetoM'] = {
    'expr': 'Sum$(CleanJet_pt > 20. && abs(CleanJet_eta) < 2.5 && Jet_btagDeepB[CleanJet_jetIdx] > 0.6321) == 0' #Jet_btagDeepB
}

aliases['bVetoT'] = {
    'expr': 'Sum$(CleanJet_pt > 20. && abs(CleanJet_eta) < 2.5 && Jet_btagCSVV2[CleanJet_jetIdx] > 0.9535) == 0' #Jet_btagDeepB
}
...
'''
aliases['wz_region']={
    'expr': 'nLepton>2 && nCleanJet >1 && MET_pt>40 && abs(Alt$(CleanJet_eta[0],-9999.)) < 4.7&& abs(Alt$(CleanJet_eta[1],-9999.)) < 4.7 && lep0eta && lep1eta && lep2eta && ztag_wz && mll_cut_wz && pid_wz && jetpt30 && softmuon_veto'  # bjet pt
}
'''
# zz region
aliases['ztag_zz']={
