...
cuts['lowmjj_jeteta_exclude'] = {
    'expr': 'ssww_region',
    # Define the sub-categorization of sr
    'categories' : {
        'region' : 'jetpt30 && leppt30 && mjj < 500 && bVeto && softmuon_veto && jeteta_exclude',
    }
}
cuts['lowmjj_ee'] = {
    'expr': 'ssww_region',
...
cuts['top_jeteta_exclude'] = {
    'expr': 'ssww_region',
    # Define the sub-categorization of sr
    'categories' : {
        'region' : 'zlep_ww && jetpt30 && leppt30 && mjj > 500 && abs(detajj)>2.5 && (!bVeto||!softmuon_veto) && jeteta_exclude',
    }
}
cuts['top_ee'] = {
    'expr': 'ssww_region',
...
cuts['ssww_jeteta_exclude'] = {
    'expr': 'ssww_region',
    # Define the sub-categorization of sr
    'categories' : {
        'region' : 'zlep_ww && bVeto && jetpt30 && leppt30 && mjj > 500 && abs(detajj)>2.5 && softmuon_veto && jeteta_exclude',
    }
}
cuts['ssww_ee'] = {
    'expr': 'ssww_region',
