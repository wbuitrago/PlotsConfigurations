...
# tau veto
aliases['fiducial'] = {
    'linesToAdd': ['.L %s/ssww/diff_cr_2017/fiducial.cc+' % configurations],
    'class': 'FiducialRegion',
    'samples': mc,
}
aliases['genmjj'] = {
    'linesToAdd': ['.L %s/ssww/diff_cr_2017/genmjj.cc+' % configurations],
    'class': 'Genmjj',
    'samples': mc,
}
aliases['genmll'] = {
    'linesToAdd': ['.L %s/ssww/diff_cr_2017/genmll.cc+' % configurations],
    'class': 'Genmll',
    'samples': mc,
}
aliases['genlep1pt'] = {
    'linesToAdd': ['.L %s/ssww/diff_cr_2017/genlep1pt.cc+' % configurations],
    'class': 'Genlep1pt',
    'samples': mc,
}
aliases['genlep2pt'] = {
    'linesToAdd': ['.L %s/ssww/diff_cr_2017/genlep2pt.cc+' % configurations],
    'class': 'Genlep2pt',
    'samples': mc,
}
aliases['genjet1pt'] = {
    'linesToAdd': ['.L %s/ssww/diff_cr_2017/genjet1pt.cc+' % configurations],
    'class': 'Genjet1pt',
    'samples': mc,
}
aliases['genjet2pt'] = {
    'linesToAdd': ['.L %s/ssww/diff_cr_2017/genjet2pt.cc+' % configurations],
    'class': 'Genjet2pt',
    'samples': mc,
}
'''
