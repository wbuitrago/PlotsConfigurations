...
aliases['fakeWEleUp'] = {
    ...
    #'expr': 'fakeW_ele_'+eleWP+'_mu_'+muWP+'_3lEleUp',
    'samples': ['Fake_lep']
}
aliases['fakeWEleDown'] = {
    'expr': 'fakeW2l_ele_'+eleWP+'_mu_'+muWP+'_EleDown',
    #'expr': 'fakeW_ele_'+eleWP+'_mu_'+muWP+'_3lEleDown',
    'samples': ['Fake_lep']
}
aliases['fakeWMuUp'] = {
...
aliases['fakeWStatEleUp'] = {
    ...
    #'expr': 'fakeW_ele_'+eleWP+'_mu_'+muWP+'_3lstatEleUp',
    'samples': ['Fake_lep']
}
aliases['fakeWStatEleDown'] = {
    'expr': 'fakeW2l_ele_'+eleWP+'_mu_'+muWP+'_statEleDown',
    #'expr': 'fakeW_ele_'+eleWP+'_mu_'+muWP+'_3lstatEleDown',
    'samples': ['Fake_lep']
}
...
aliases['leppt30_wz']={
    'expr': 'Alt$(Lepton_pt[0],-9999.) >30 && Alt$(Lepton_pt[1],-9999.) >30 && Alt$(Lepton_pt[3],-9999.) <10'#Alt$(Lepton_pt[2],-9999.) >10'
}
...
aliases['SFweight'] = {
    'expr': ' * '.join(['SFweight2l', 'LepSF2l__ele_' + eleWP + '__mu_' + muWP, 'LepWPCut','PrefireWeight','PromptGenLepMatch2l','XSWeight','METFilter_MC','btagSF']),
