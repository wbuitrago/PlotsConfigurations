...
class Genjet1pt : public multidraw::TTreeFunction {
public:
  Genjet1pt();

  char const* getName() const override { return "Genjet1pt"; }
  TTreeFunction* clone() const override { return new Genjet1pt(); }
...
Genjet1pt::evaluate(unsigned)
{
  ...
  if (n<1)
    return -9999.;
  return GenJet_pt->At(iCleanJ[0]);
}

void
Genjet1pt::bindTree_(multidraw::FunctionLibrary& _library)
{
