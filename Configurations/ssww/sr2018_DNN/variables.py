...
variables['Jet_pt1']  = {   'name'  : 'CleanJet_pt[0]',
                            'range' : ([30,80,120,150,200,300],),
                            'xaxis' : 'p_{T} 1st jet [GeV]',
                            'fold'  : 3
                        }
variables['Jet_pt2']  = {   'name'  : 'CleanJet_pt[1]',
                            'range' : ([30,70,100,130,200],),
                            'xaxis' : 'p_{T} 2nd jet [GeV]',
                            'fold'  : 3
                        }
# eta
variables['Jet_eta1'] = {  'name' : 'CleanJet_eta[0]',
                        'range': (10,-5,5),
                        'xaxis': 'eta j1',
                        'fold' : 3
                    }
variables['Jet_eta2'] = {  'name' : 'CleanJet_eta[1]',
                        'range': (10,-5,5),
                        'xaxis': 'eta j2',
                        'fold' : 3
                    }
...
variables['Jet_phi1'] = {     'name' : 'CleanJet_phi[0]',
                            'range': (10,-3.141592,3.141592),
                            'xaxis': 'phi_j1',
                            'fold' : 3
                    }

variables['Jet_phi2'] = { 'name' : 'CleanJet_phi[1]',
                        'range': (10,-3.141592,3.141592),
                        'xaxis': 'phi_j2',
                        'fold' : 3
                        }
...
#### Zeppenfeld Variable ####
#############################
variables['zlep1']  = {  'name': 'abs(Lepton_eta[0] - (CleanJet_eta[0]+CleanJet_eta[1])/2)/detajj)',
                            'range': (10,0,1.5),
                            'xaxis': 'Z^{lep}_{1}',
                            'fold': 3
                            }

variables['Zlep2']  = {  'name': 'abs(Lepton_eta[1] - (CleanJet_eta[0]+CleanJet_eta[1])/2)/detajj)',
                        'range': (10,0,1.5),
                        'xaxis': 'Z^{lep}_{2}',
                        'fold': 3
                        }