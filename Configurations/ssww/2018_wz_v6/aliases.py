...
aliases['wzinc'] = {
    'linesToAdd': ['.L %s/ssww/2018_wz_v6/wzinc.cc+' % configurations],
    'class': 'Wzinc',
}
aliases['zz'] = {
    'linesToAdd': ['.L %s/ssww/2018_wz_v6/zz.cc+' % configurations],
    'class': 'Zz',
}
...
'''
aliases['wz_region']={
    'expr': 'nLepton>2 && nCleanJet >1 && MET_pt>40 && abs(Alt$(CleanJet_eta[0],-9999.)) < 4.7&& abs(Alt$(CleanJet_eta[1],-9999.)) < 4.7 && lep0eta && lep1eta && lep2eta && ztag_wz && pid_wz && jetpt30 && softmuon_veto'  # bjet pt
}
'''
# zz region
aliases['ztag_zz']={
