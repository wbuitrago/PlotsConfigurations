...
aliases['zz'] = {
    'linesToAdd': ['.L %s/ssww/l4_2017/zz.cc+' % configurations],
    'class': 'Zz',
}
aliases['loosezz'] = {
    'linesToAdd': ['.L %s/ssww/l4_2017/loosezz.cc+' % configurations],
    'class': 'Loosezz',
}
# chargeflip
aliases['chargeflip_w'] = {
    'linesToAdd': ['.L %s/ssww/l4_2017/mischarge_sf.cc+' % configurations],
    'class': 'misID_sf',
    'samples': mc,
}
...
aliases['mcCommonWeight_os'] = {
    'expr': 'SFweight*PromptGenLepMatch2l',#
    'samples':mc
}
# variations
