...
misID_sf::evaluate(unsigned)
{
  ...
  double chargeflip_rate[3]={5.00870e-05,3.48575e-04,1.16961e-03};
  //double chargeflip_rate[3]={4.78638e-05,2.46734e-04,8.36552e-04};
  //double sf[3]={1.04645,1.41275,1.39813};
  int idx1=0;
  int idx2=0;
