...
samples['ttbar'] = 	{ 	'name'  :getSampleFiles(chargeFlipDir,'TTTo2L2Nu',False,'nanoLatino_')
                                    +getSampleFiles(chargeFlipDir,'ST_s-channel_ext1',False,'nanoLatino_')
                                    ...
                                    +getSampleFiles(chargeFlipDir,'ST_tW_antitop_ext1',False,'nanoLatino_')
                                    +getSampleFiles(chargeFlipDir,'ST_tW_top_ext1',False,'nanoLatino_')
    ,
                           'weight' : XSWeight+'*'+SFweight+'*'+GenLepMatch+'*'+METFilter_MC+'*ChargeFlipW_vbs',
                           'FilesPerJob' : 15 ,
                           }
