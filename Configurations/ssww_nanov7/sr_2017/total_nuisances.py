...
nuisances['lumi_XYFact'] = {
    ...
    'type': 'lnN',
    'samples': dict((skey, '1.008') for skey in mc if skey not in CFMC)
}

nuisances['lumi_LScale'] = {
    'name': 'lumi_13TeV_LSCale',
    'type': 'lnN',
    'samples': dict((skey, '1.003') for skey in mc if skey not in CFMC)
}
...
nuisances['lumi_Ghosts'] = {
    ...
    'type': 'lnN',
    'samples': dict((skey, '1.001') for skey in mc if skey not in CFMC)
}
#### FAKES
...
nuisances['eff_highpt_m'] = {
    ...
    'kind': 'weight',
    'type': 'shape',
    'samples': dict((skey, ['sfweight_MuUp', 'sfweight_MuDo']) for skey in mc if skey not in CFMC),
}
...
variations = ['LHEScaleWeight[%d]' % i for i in range(0,44)]
