...
mcDirectory = '/eos/cms/store/group/phys_higgs/cmshww/amassiro/HWWNano/Fall2017_102X_nAODv7_Full2017v7/MCl1loose2017v7__MCCorr2017v7__l2loose__l2tightOR2017v7/'
# mcDirectory = '/eos/user/j/jixiao/HWWnano3/link/Fall2017_102X_nAODv7_Full2017v7/MCl1loose2017v7__MCCorr2017v7__l2loose__l2tightOR2017v7'
...
############ BASIC MC WEIGHTS ##################
################################################
mcCommonWeightNoMatch = 'SFweight*(Alt$(Lepton_pdgId[0],-9999) * Alt$(Lepton_pdgId[1],9999) > 0)'
mcCommonWeight = 'SFweight*PromptGenLepMatch2l*(Alt$(Lepton_pdgId[0],-9999) * Alt$(Lepton_pdgId[1],9999) > 0)'
############################################
############ MORE MC STAT ##################
############################################
...
### WZ QCD
files = nanoGetSampleFiles(mcDirectory, 'WZTo3LNu_noPSweights')
...
files = nanoGetSampleFiles(mcDirectory, 'ggZZ2e2m_ext1') + \
...
files = nanoGetSampleFiles(mcDirectory, 'TTZToLLNuNu_M-10') + \
        nanoGetSampleFiles(mcDirectory, 'TTWJetsToLNu_PSweights_newpmx')
samples['ttV'] = {
    'name': files,
    'weight': mcCommonWeight,
    'suppressNegative' :['all'],
...
for _, sd in DataRun:
    for pd in DataSets:
        files = nanoGetSampleFiles('/eos/cms/store/group/phys_higgs/cmshww/amassiro/HWWNano/Run2017_102X_nAODv7_Full2017v7/DATAl1loose2017v7__l2loose__fakeW/', pd + '_' + sd)
...
for _, sd in DataRun:
    for pd in DataSets:
        files = nanoGetSampleFiles('/eos/cms/store/group/phys_higgs/cmshww/amassiro/HWWNano/Run2017_102X_nAODv7_Full2017v7/DATAl1loose2017v7__l2loose__l2tightOR2017v7/', pd + '_' + sd)
