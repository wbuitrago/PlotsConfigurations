...
bWP = "0.6321" 
# deepjet 0.0614 0.3093 0.7221
# deepcsv 0.2217 0.6321 0.8953
...
aliases['gstarLow'] = {
    ...
    'samples': ['low_VgS','high_VgS','res_VgS','ge_VgS']
}
...
aliases['SFweight'] = {
    'expr': ' * '.join(['SFweight3l','LepSF3l__ele_' + eleWP + '__mu_' + muWP, 'LepWPCut','XSWeight','METFilter_MC','btagSF','PrefireWeight','Jet_PUIDSF']),
    'samples': mc
}
# variations
