...
mcDirectory = '/eos/cms/store/group/phys_higgs/cmshww/amassiro/HWWNano/Summer16_102X_nAODv7_Full2016v7/MCl1loose2016v7__MCCorr2016v7__l2loose__l2tightOR2016v7/'
# mcDirectory = '/eos/user/j/jixiao/HWWnano3/link/Summer16_102X_nAODv7_Full2016v7/MCl1loose2016v7__MCCorr2016v7__l2loose__l2tightOR2016v7'
...
files = nanoGetSampleFiles(mcDirectory, 'ZZTo4L_ext1')
samples['ZZ4L'] = {
    'name': files,
    'weight': mcCommonWeight,
    'suppressNegative' :['all'],
...
#    'FilesPerJob': 4
#}
files = nanoGetSampleFiles(mcDirectory, 'tZq_ll_4f')
samples['tZq'] = {
    'name': files,
    'weight': mcCommonWeight,
    'suppressNegative' :['all'],
...
# old: WGJJ Zg
files = nanoGetSampleFiles(mcDirectory, 'Zg_ext1') + \
...
for _, sd in DataRun:
    for pd in DataSets:
        files = nanoGetSampleFiles('/eos/cms/store/group/phys_higgs/cmshww/amassiro/HWWNano/Run2016_102X_nAODv7_Full2016v7/DATAl1loose2016v7__l2loose__fakeW/', pd + '_' + sd)
...
for _, sd in DataRun:
    for pd in DataSets:
        files = nanoGetSampleFiles('/eos/cms/store/group/phys_higgs/cmshww/amassiro/HWWNano/Run2016_102X_nAODv7_Full2016v7/DATAl1loose2016v7__l2loose__l2tightOR2016v7/', pd + '_' + sd)
