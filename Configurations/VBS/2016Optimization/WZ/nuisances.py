...
nuisances['btagbc']  = {
                ...
                'samples'  : {
                   ...
                   'WZ_strong'  : ['(bPogSF_CSVM_bc_up)/(bPogSF)', '(bPogSF_CSVM_bc_down)/(bPogSF)'],
                   'WZ_EWK'  : ['(bPogSF_CSVM_bc_up)/(bPogSF)', '(bPogSF_CSVM_bc_down)/(bPogSF)'],
...
nuisances['btagudsg']  = {
                ...
                'samples'  : {
                   ...
                   'WZ_strong'  : ['(bPogSF_CSVM_udsg_up)/(bPogSF)', '(bPogSF_CSVM_udsg_down)/(bPogSF)'],
                   ...
                   'WZ_EWK'  : ['(bPogSF_CSVM_udsg_up)/(bPogSF)', '(bPogSF_CSVM_udsg_down)/(bPogSF)'],
                }
} 
...
nuisances['trigg']  = {
                ...
                'samples'  : {
                   ...
                   'WZ_strong'  : ['(effTrigW_Up)/(effTrigW)', '(effTrigW_Down)/(effTrigW)'],
                   'WZ_EWK'  : ['(effTrigW_Up)/(effTrigW)', '(effTrigW_Down)/(effTrigW)'],
...
nuisances['idiso_ele']  = {
                ...
                'WZ_strong' : ['((abs(std_vector_lepton_flavour[0]) == 11)*(std_vector_lepton_idisoWcut_WP_Tight80X_Up[0])/(std_vector_lepton_idisoWcut_WP_Tight80X[0])+(abs(std_vector_lepton_flavour[0]) == 13)) * ((abs(std_vector_lepton_flavour[1]) == 11)*(std_vector_lepton_idisoWcut_WP_Tight80X_Up[1])/(std_vector_lepton_idisoWcut_WP_Tight80X[1])+(abs(std_vector_lepton_flavour[1]) == 13))', '((abs(std_vector_lepton_flavour[0]) == 11)*(std_vector_lepton_idisoWcut_WP_Tight80X_Down[0])/(std_vector_lepton_idisoWcut_WP_Tight80X[0])+(abs(std_vector_lepton_flavour[0]) == 13)) * ((abs(std_vector_lepton_flavour[1]) == 11)*(std_vector_lepton_idisoWcut_WP_Tight80X_Down[1])/(std_vector_lepton_idisoWcut_WP_Tight80X[1])+(abs(std_vector_lepton_flavour[1]) == 13))'],
...
nuisances['idiso_mu']  = {
                ...
                'samples'  : {
                  ...
                  'WZ_strong' : ['((abs(std_vector_lepton_flavour[0]) == 13)*(std_vector_lepton_idisoWcut_WP_Tight80X_Up[0])/(std_vector_lepton_idisoWcut_WP_Tight80X[0])+(abs(std_vector_lepton_flavour[0]) == 11)) * ((abs(std_vector_lepton_flavour[1]) == 13)*(std_vector_lepton_idisoWcut_WP_Tight80X_Up[1])/(std_vector_lepton_idisoWcut_WP_Tight80X[1])+(abs(std_vector_lepton_flavour[1]) == 11))', '((abs(std_vector_lepton_flavour[0]) == 13)*(std_vector_lepton_idisoWcut_WP_Tight80X_Down[0])/(std_vector_lepton_idisoWcut_WP_Tight80X[0])+(abs(std_vector_lepton_flavour[0]) == 11)) * ((abs(std_vector_lepton_flavour[1]) == 13)*(std_vector_lepton_idisoWcut_WP_Tight80X_Down[1])/(std_vector_lepton_idisoWcut_WP_Tight80X[1])+(abs(std_vector_lepton_flavour[1]) == 11))'],
