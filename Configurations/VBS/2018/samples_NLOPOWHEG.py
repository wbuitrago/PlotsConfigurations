...
samples['ZZ4L_POWHEGNLO'] = {  'name'  :   nanoGetSampleFiles(MCDir,'ZZTo4L_ext1')
...
addSampleWeight(samples,'ZZ4L_POWHEGNLO','ZZTo4L_ext1',   "1.07*"+ZZ4LbaseW+"/baseW")
addSampleWeight(samples,'ZZ4L_POWHEGNLO','ZZTo4L_ext2',   "1.07*"+ZZ4LbaseW+"/baseW")
