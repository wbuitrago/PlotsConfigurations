...
# cuts['ssww_tri_btag_tauVeto_pt215']=ww1+'&&'+ bJetTag+'&&'+zlep+'&&'+zveto+'&&'+ssww+'&&'+triple_charge+'&& tauVeto_ww'
# cuts['ssww_tri_btag_tauVeto_pt216']=ww2+'&&'+ bJetTag+'&&'+zlep+'&&'+zveto+'&&'+ssww+'&&'+triple_charge+'&& tauVeto_ww'
# cuts['ssww_tri_btag_tauVeto_pt217']=ww3+'&&'+ bJetTag+'&&'+zlep+'&&'+zveto+'&&'+ssww+'&&'+triple_charge+'&& tauVeto_ww'
# cuts['ssww_tri_btag_tauVeto_pt218']=ww4+'&&'+ bJetTag+'&&'+zlep+'&&'+zveto+'&&'+ssww+'&&'+triple_charge+'&& tauVeto_ww'
# cuts['ssww_tri_btag_tauVeto_pt219']=ww5+'&&'+ bJetTag+'&&'+zlep+'&&'+zveto+'&&'+ssww+'&&'+triple_charge+'&& tauVeto_ww'

cuts['ssww_tri_btag_tauVeto_jetpt230']=ww6+'&&'+ bJetTag+'&&'+zlep+'&&'+zveto+'&&'+ssww+'&&'+triple_charge+'&& tauVeto_ww'

# cuts['ssww_tri_tauVeto_pt215']=ww1+'&& bVeto &&'+zlep+'&&'+zveto+'&&'+ssww+'&&'+triple_charge+'&& tauVeto_ww'
# cuts['ssww_tri_tauVeto_pt216']=ww2+'&& bVeto &&'+zlep+'&&'+zveto+'&&'+ssww+'&&'+triple_charge+'&& tauVeto_ww'
# cuts['ssww_tri_tauVeto_pt217']=ww3+'&& bVeto &&'+zlep+'&&'+zveto+'&&'+ssww+'&&'+triple_charge+'&& tauVeto_ww'
# cuts['ssww_tri_tauVeto_pt218']=ww4+'&& bVeto &&'+zlep+'&&'+zveto+'&&'+ssww+'&&'+triple_charge+'&& tauVeto_ww'
# cuts['ssww_tri_tauVeto_pt219']=ww5+'&& bVeto &&'+zlep+'&&'+zveto+'&&'+ssww+'&&'+triple_charge+'&& tauVeto_ww'
...
# cuts['WZb_tri']=wz+'&&'+bJetTag+'&&'+zlep_wz+'&&'+ztag+'&&'+triple_charge_wz # mlll
# cuts['WZb_tri_tauVeto']=wz+'&&'+bJetTag+'&&'+zlep_wz+'&&'+ztag+'&&'+triple_charge_wz+'&& tauVeto_wz' # mlll
