...
variables['METFilter_DATA']  = {   'name': 'METFilter_DATA',
                                   'range' : (10,-1.,1),
                                   'xaxis' : 'METFilterDATA',
                                   'fold' : 3
                                   }
variables['fakeWSS']  = {   'name': 'fakeW2l_ele_mvaFall17V1Iso_WP90_SS_tthmva_70_mu_cut_Tight_HWWW_tthmva_80',
                            'range' : (10,-1.,1),
                            'xaxis' : 'fakeWSS',
                            'fold' : 3
                            }
...
variables['weight']  = {   'name': 'fakeW2l_ele_mvaFall17V1Iso_WP90_SS_tthmva_70_mu_cut_Tight_HWWW_tthmva_80*METFilter_DATA',
                            'range' : (20,0.,1),
                            'xaxis' : 'weight',
                            'fold' : 3
                            }
...
variables = {k:v for k,v in variables.items() if k in ["events", "METFilter_DATA", "fakeWSS","fakeWSS_v2", "weight", "mjj", "pt2", "pt1", "mll", "detajj", "mtw1", "mtw2"]}
