...
files = nanoGetSampleFiles(MCDir, 'ggZZ4m')
samples['ggZZ4m'] = {
    'name': files,
    'weight': mcCommonWeight,
    'FilesPerJob': 4
}
files = nanoGetSampleFiles(MCDir, 'ggZZ4m_ext1')
samples['ggZZ4m_ext1'] = {
    'name': files,
    'weight': mcCommonWeight,
    'FilesPerJob': 4
}
files = nanoGetSampleFiles(MCDir, 'ggZZ4t')
samples['ggZZ4t'] = {
    'name': files,
    'weight': mcCommonWeight,
    'FilesPerJob': 4
}
files = nanoGetSampleFiles(MCDir, 'ggZZ2e2t')
samples['ggZZ2e2t'] = {
    'name': files,
    'weight': mcCommonWeight,
    'FilesPerJob': 4
}
files = nanoGetSampleFiles(MCDir, 'ggZZ2m2t')
samples['ggZZ2m2t'] = {
    'name': files,
    'weight': mcCommonWeight,
    'FilesPerJob': 4
}
files = nanoGetSampleFiles(MCDir, 'ggZZ2e2m')
samples['ggZZ2e2m'] = {
    'name': files,
    'weight': mcCommonWeight,
    'FilesPerJob': 4
}
files = nanoGetSampleFiles(MCDir, 'ggToZZTo4e')
samples['ggToZZTo4e'] = {
    'name': files,
    'weight': mcCommonWeight,
    'FilesPerJob': 4
}
files = nanoGetSampleFiles(MCDir, 'ggToZZTo4e_ext1')
samples['ggToZZTo4e_ext1'] = {
    'name': files,
    'weight': mcCommonWeight,
    'FilesPerJob': 4
}
