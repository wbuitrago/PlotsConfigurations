...
public:
  Zz(const char* variable_);

  char const* getName() const override { return "Zz"; }
  TTreeFunction* clone() const override { return new Zz(variable.c_str()); }
...
Zz::evaluate(unsigned)
{
  ...
  //if (Met<=30)
  //  return 0.;
  if (variable == "m4l") return ((pl[z0lepton1_idx]+pl[z0lepton2_idx]+pl[z1lepton1_idx]+pl[z1lepton2_idx]).M());
  if (variable == "mZ1") return z0Mass_min;
  if (variable == "mZ2") return z1Mass_min;
