...
ww_wsel = 'Alt$(Lepton_pt[0],0.)>25 && Alt$(Lepton_pt[1],0.)<10 && Alt$(CleanJet_pt[0],-9999.)>30 && MET_pt >30'  # bveto tauveto zveto zlep
...
# cuts['ssww_zeta_selections']=ww_zsel+'&& bVeto &&'+zlep+'&&'+zsel+'&&'+triple_charge+'&& tauVeto_ww'
...
cuts['ssww_w_selections']=ww_wsel+'&& bVeto && tauVeto_ww'
