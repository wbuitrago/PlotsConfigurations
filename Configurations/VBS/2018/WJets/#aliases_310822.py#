...
#     'expr': 'SFweight2l*PromptGenLepMatch2l*chargeflip_w*(Alt$(Lepton_pdgId[0],-9999) * Alt$(Lepton_pdgId[1],-9999) < 0)',
#     'samples':mc
# }
# aliases['mcCommonWeight_DY'] = {
#     'expr': 'SFweight_mod*PromptGenLepMatch2l*(Alt$(Lepton_pdgId[0],-9999) * Alt$(Lepton_pdgId[1],-9999) < 0)',
#     'samples':mc
# }
