...
variables['nCleanJet']  = {   'name': 'nCleanJet',
                         'range' : (6,0.,6),
                         'xaxis' : 'nCleanJet',
                         'fold' : 3
                         }
...
variables['jetpt1_v2']  = {   'name': 'Alt$(Jet_pt[0],-9999.)',
                           'range' : (30,40,500),
                           'xaxis' : 'p_{T} 1st jet',
                           'fold'  : 3
                           }

variables['jetpt2_v2']  = {   'name': 'Alt$(Jet_pt[1],-9999.)',
                              'range' : (30,40,400),
                           'xaxis' : 'p_{T} 2nd jet',
                           'fold'  : 3
                           }
...
variables = {k:v for k,v in variables.items() if k in ["events", "mjj", "mll","mll_v2","mll_v3","mll_v4" , "detajj", "nCleanJet", "nJet", "jetpt1", "jetpt2","jetpt1_v2", "jetpt2_v2", "pt1", "pt2"]}
