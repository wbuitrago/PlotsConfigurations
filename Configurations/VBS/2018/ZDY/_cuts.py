...
ww_zsel = 'Alt$(Lepton_pt[0],0.)>25 && Alt$(Lepton_pt[1],0.)>20 && Alt$(Lepton_pt[2],0.)<10'  # bveto tauveto zveto zlep
...
cuts['ssww_zeta_selections_ee']=ww_zsel+'&&'+zsel_ee+'&&'+triple_charge
cuts['ssww_zeta_selections_mm']=ww_zsel+'&&'+zsel_mm+'&&'+triple_charge
