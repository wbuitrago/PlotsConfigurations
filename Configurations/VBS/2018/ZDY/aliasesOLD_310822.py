...
aliases['SFweight_mod'] = {
    'expr': ' * '.join(['SFweight2l','LepSF2l__ele_' + eleWP + '__mu_' + muWP, 'LepWPCut','METFilter_MC','btagSF']), #bveto_sf*lep_sf*trig_sf*mu_roc_sf
    #'expr': 'LepWPCut',
    'samples': mc
}
...
#	'samples' : mc
#}
#aliases['SFweight_mod2'] = {
#    'expr': ' * '.join(['SFweight2lAlt','LepSF2l__ele_' + eleWP + '__mu_' + muWP, 'LepWPCut','METFilter_MC','btagSF','Jet_PUIDSF_loose']), #bveto_sf*lep_sf*trig_sf*mu_roc_sf
#    #'expr': 'LepWPCut',
#    'samples': mc
#}
aliases['mcCommonWeight_os'] = {
    'expr': 'SFweight_mod*PromptGenLepMatch2l*chargeflip_w*(Alt$(Lepton_pdgId[0],-9999) * Alt$(Lepton_pdgId[1],-9999) < 0) * XSWeight',
    #'expr': 'SFweight2l_mod2*PromptGenLepMatch2l*chargeflip_w*(Alt$(Lepton_pdgId[0],-9999) * Alt$(Lepton_pdgId[1],-9999) < 0) * XSWeight',
    'samples':mc
}
#aliases['mcCommonWeight_DY'] = {
#    'expr': 'SFweight_mod*PromptGenLepMatch2l*chargeflip_w*(Alt$(Lepton_pdgId[0],-9999) * Alt$(Lepton_pdgId[1],-9999) < 0)',
#    'samples':mc
#}
