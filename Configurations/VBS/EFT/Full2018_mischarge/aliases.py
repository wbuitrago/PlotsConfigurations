...
# Leptons Flavour Categories ee emu mumu without sign requests
aliases['ee']   = { 'expr': 'abs(Alt$(Lepton_pdgId[0],0.)*Alt$(Lepton_pdgId[1],0.)) == 11*11'} # double electron      
aliases['emu']  = { 'expr': 'abs(Alt$(Lepton_pdgId[0],0.)*Alt$(Lepton_pdgId[1],0.)) == 11*13'} # muon & electron
aliases['mumu'] = { 'expr': 'abs(Alt$(Lepton_pdgId[0],0.)*Alt$(Lepton_pdgId[1],0.)) == 13*13'} # double muon
