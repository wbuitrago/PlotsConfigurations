...
misID_sf::evaluate(unsigned)
{
  ...
  double chargeflip_rate[3]={5.37210e-05,5.17267e-04,2.29762e-03};
  //double chargeflip_rate[3]={6.29379e-05,6.44315e-04,2.00877e-03};
  //double sf[3]={0.853555,0.802817,1.1438};
  int idx1=0;
  int idx2=0;
  ...
  if (abs(Lepton_pdgId->At(iPromptL[0]))!=11){
    _rate1=0;
  }
  if (abs(Lepton_pdgId->At(iPromptL[1]))!=11){
    _rate2=0;
  }
