...
aliases['zz'] = {
    'linesToAdd': ['.L %s/ssww/l4_2018/zz.cc+' % configurations],
    'class': 'Zz',
}
aliases['loosezz'] = {
    'linesToAdd': ['.L %s/ssww/l4_2018/loosezz.cc+' % configurations],
    'class': 'Loosezz',
}
# chargeflip
aliases['chargeflip_w'] = {
    'linesToAdd': ['.L %s/ssww/l4_2018/mischarge_sf.cc+' % configurations],
    'class': 'misID_sf',
    'samples': mc,
}
# tau veto
