...
# DNN reader WW
dnn_reader_path = os.getenv('CMSSW_BASE') + '/src/PlotsConfigurations/Configurations/ssww/l3_2017/dnn/'
models_path_WW = '/eos/user/j/jixiao/latino/2017_WW/'
aliases['DNNScore_WW'] = {
    'class': 'DNNScore',
...
aliases['chargeflip_w'] = {
    'linesToAdd': ['.L %s/ssww/l3_2017/mischarge_sf.cc+' % configurations],
    'class': 'misID_sf',
    'samples': mc,
}
# chargeflip
