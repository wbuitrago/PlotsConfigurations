...
# DNN reader WW
dnn_reader_path = os.getenv('CMSSW_BASE') + '/src/PlotsConfigurations/Configurations/ssww/l3_2016/dnn/'
...
aliases['wzinc'] = {
    'linesToAdd': ['.L %s/ssww/l3_2016/wzinc.cc+' % configurations],
    'class': 'Wzinc',
}
# tau veto
aliases['tauVeto_wz'] = {
...
aliases['chargeflip_w'] = {
    'linesToAdd': ['.L %s/ssww/l3_2016/mischarge_sf.cc+' % configurations],
    'class': 'misID_sf',
    'samples': mc,
}
# chargeflip
