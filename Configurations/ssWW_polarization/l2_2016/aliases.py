...
# DNN reader WW
dnn_reader_path = os.getenv('CMSSW_BASE') + '/src/PlotsConfigurations/Configurations/ssww/l2_2016/dnn/'
models_path_WW = '/eos/user/j/jixiao/latino/2016_WW/'
aliases['DNNScore_WW'] = {
    'class': 'DNNScore',
...
# fiducial
aliases['fid'] = {
    'linesToAdd': ['.L %s/ssww/l2_2016/fiducial.cc+' % configurations],
    'class': 'FiducialRegion',
    'samples': mc,
}
# chargeflip
aliases['chargeflip_w'] = {
    'linesToAdd': ['.L %s/ssww/l2_2016/mischarge_sf.cc+' % configurations],
    'class': 'misID_sf',
    'samples': mc,
}
# chargeflip
