...
mcDirectory = '/eos/user/j/jixiao/HWWnano3/link/Summer16_102X_nAODv5_Full2016v6/MCl1loose2016v6__MCCorr2016v6__l2loose__l2tightOR2016v6/'
...
samples['LL_fid'] = {
    'name': files,
    'weight': mcCommonWeight+'*EW_weight*fid',
    'FilesPerJob': 11
}
...
#files = nanoGetSampleFiles(mcDirectory, 'llPPrf')
#samples['LL2'] = {
#    'name': files,
#    'weight': mcCommonWeight,
#    'FilesPerJob': 4
#}
#files = nanoGetSampleFiles(mcDirectory, 'tlPPrf')
#samples['TL2'] = {
#    'name': files,
#    'weight': mcCommonWeight,
#    'FilesPerJob': 4
#}
#files = nanoGetSampleFiles(mcDirectory, 'ttPPrf')
#samples['TT2'] = {
#    'name': files,
#    'weight': mcCommonWeight,
#    'FilesPerJob': 4
...
#files = nanoGetSampleFiles(mcDirectory, 'VBS_WZ_LL_WZ_CM')
#samples['WZ_LL_EWK'] = {
#    'name': files,
#    'weight': mcCommonWeight,
#    'FilesPerJob': 4
#}
#files = nanoGetSampleFiles(mcDirectory, 'VBS_WZ_TL_WZ_CM')
#samples['WZ_TL_EWK'] = {
#    'name': files,
#    'weight': mcCommonWeight,
#    'FilesPerJob': 4
#}
#files = nanoGetSampleFiles(mcDirectory, 'VBS_WZ_LT_WZ_CM')
#samples['WZ_LT_EWK'] = {
#    'name': files,
#    'weight': mcCommonWeight,
#    'FilesPerJob': 4
#}
#files = nanoGetSampleFiles(mcDirectory, 'VBS_WZ_TT_WZ_CM')
#samples['WZ_TT_EWK'] = {
#    'name': files,
#    'weight': mcCommonWeight,
#    'FilesPerJob': 4
