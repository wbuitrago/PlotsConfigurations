...
groupPlot['non-prompt']  = dict(nameHR='non-Prompt', isSignal=0, color=ROOT.kYellow - 4, samples=['Fake'])
groupPlot['TT']  = dict(nameHR="W^{#pm}W^{#pm} EWK TT", isSignal=0, color=ROOT.kBlue, samples=['TT'])
groupPlot['TL']  = dict(nameHR="W^{#pm}W^{#pm} EWK TL", isSignal=0, color=ROOT.kBlue +3, samples=['TL'])
groupPlot['LL']  = dict(nameHR="W^{#pm}W^{#pm} EWK LL", isSignal=0, color=ROOT.kBlue - 10, samples=['LL'])
#groupPlot['TT']  = dict(nameHR="W^{#pm}W^{#pm} EWK TT", isSignal=0, color=ROOT.kBlue, samples=['TT2'])
#groupPlot['TL']  = dict(nameHR="W^{#pm}W^{#pm} EWK TL", isSignal=0, color=ROOT.kBlue +3, samples=['TL2'])
#groupPlot['LL']  = dict(nameHR="W^{#pm}W^{#pm} EWK LL", isSignal=0, color=ROOT.kBlue - 10, samples=['LL2'])
...
plot['LL']  = dict(color=Azure + 4, isSignal=0, isData=0, scale=1.0) # WpWpJJ_EWK_powheg WpWp_EWK
plot['TL']  = dict(color=Azure + 4, isSignal=0, isData=0, scale=1.0) # WpWpJJ_EWK_powheg WpWp_EWK
plot['TT']  = dict(color=Azure + 4, isSignal=0, isData=0, scale=1.0) # WpWpJJ_EWK_powheg WpWp_EWK
#plot['LL2']  = dict(color=Azure + 4, isSignal=0, isData=0, scale=1.0) # WpWpJJ_EWK_powheg WpWp_EWK
#plot['TL2']  = dict(color=Azure + 4, isSignal=0, isData=0, scale=1.0) # WpWpJJ_EWK_powheg WpWp_EWK
#plot['TT2']  = dict(color=Azure + 4, isSignal=0, isData=0, scale=1.0) # WpWpJJ_EWK_powheg WpWp_EWK
