...
variables['yll']  = {   'name'  : 'yll',         #  variable name
                        'range' : (5,-5.0,5.0),       #  variable range
                        'xaxis' : 'met [GeV]',      #  x axis name
                        'fold'  : 3
                        }
variables['mTi']  = {   'name'  : 'mTi',         #  variable name
                        'range' : (5,30,1000),       #  variable range
...
variables['dphillmet']  = {   'name'  : 'dphillmet',         #  variable name
                            'range' : (5,0,3.15),       #  variable range
                            'xaxis' : 'dphillmet [GeV]',      #  x axis name
                            'fold'  : 3
                            }
variables['pTWW']  = {   'name'  : 'pTWW',         #  variable name
                         'range' : (10,0,800),       #  variable range
                         'xaxis' : 'pTWW [GeV]',      #  x axis name
                         'fold'  : 3
                         }
...
variables['drj1ll']  = {   'name'  : 'drj1ll',         #  variable name
                           'range' : (10,0,10),       #  variable range
                           'xaxis' : 'drj1ll',      #  x axis name
                           'fold'  : 3
                           }
variables['drj2ll']  = {   'name'  : 'drj2ll',         #  variable name
                           'range' : (10,0,10),       #  variable range
                           'xaxis' : 'drj2ll',      #  x axis name
                           'fold'  : 3
                           }
variables['pt_ratio']  = {  'name': '((Lepton_pt[0]+Lepton_pt[1])/(Alt(CleanJet_eta,0,-9999)+Alt(CleanJet_eta,1,-9999)))',
                            'range': (100,0,10),
                            'xaxis': 'pt_ratio',
                            'fold': 3
                            }
