...
cmd_asimov = """combineTool.py -M MultiDimFit higgsCombine.initialFit.asimov.MultiDimFit.mH120.root -n .scan_all_data \
 ...
 -t -1 --expectSignal=1 \
 --algo grid --point 200 --cminDefaultMinimizerStrategy 1 --cminFallbackAlgo Minuit2,Migrad,0:0.1\
 --robustFit=1 --setRobustFitTolerance=0.1 --X-rtd FITTER_NEW_CROSSING_ALGO --X-rtd FITTER_NEVER_GIVE_UP --X-rtd FITTER_BOUND \
 --X-rtd MINIMIZER_MaxCalls=9999999 -v 3 --stepSize=0.1 \
 --skipInitialFit --split-points=5 --job-mode=condor --task-name scan_data_1 --sub-opts='+JobFlavour="testmatch"' """
...
cmd_data = """combineTool.py -M MultiDimFit higgsCombine.initialFit.data.MultiDimFit.mH120.root -n .scan_all_data \
 --rMin=0 --rMax 1.5  --snapshotName MultiDimFit  \
 --algo grid --point 100 --cminDefaultMinimizerStrategy 1 --cminFallbackAlgo Minuit2,Migrad,0:0.01\
 --robustFit=1 --setRobustFitTolerance=0.0001 --X-rtd FITTER_NEW_CROSSING_ALGO --X-rtd FITTER_NEVER_GIVE_UP --X-rtd FITTER_BOUND \
 --X-rtd MINIMIZER_MaxCalls=999999999 -v 3 --stepSize=0.01 \
 --skipInitialFit --split-points=5 --job-mode=condor --task-name scan_data_1 --sub-opts='+JobFlavour="testmatch"' """
