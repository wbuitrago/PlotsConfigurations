...
# these samples do share the same structuee in the reweight weights:

samples['tapVjj_mupVjj_epVjj_tamVjj_ewk_dim6_EFT'] = {
   'name': tapSamples + mupSamples + epSamples + tamSamples,
   'weight': "1",
   'FilesPerJob': 3,
}

# samples['tapVjj_ewk_dim6_EFT'] = {
#    'name': tapSamples,
#    'weight': "1",
#    'FilesPerJob': 50,
# }

# samples['tamVjj_ewk_dim6_EFT'] = {
#    'name': tamSamples,
#    'weight': "1",
#    'FilesPerJob': 50,
# }

# samples['mupVjj_ewk_dim6_EFT'] = {
#    'name': mupSamples,
#    'weight': "1",
#    'FilesPerJob': 50,
# }

# samples['mumVjj_ewk_dim6_EFT'] = {
#    'name': mumSamples,
#    'weight': "1",
#    'FilesPerJob': 50,
# }

# samples['epVjj_ewk_dim6_EFT'] = {
#    'name': epSamples,
#    'weight': "1",
#    'FilesPerJob': 50,
# }

# samples['emVjj_ewk_dim6_EFT'] = {
#    'name': emSamples,
#    'weight': "1",
#    'FilesPerJob': 50,
# }
...
EFT_samples = [
   ...
   # 'tamVjj_ewk_dim6_EFT',
   # 'tapVjj_ewk_dim6_EFT'
   'tapVjj_mupVjj_epVjj_tamVjj_ewk_dim6_EFT'
]
