...
groupPlot['VBS']  = {
                 ...
                 'isSignal' : 0,
                 'color': colors["kRed"]+1,
                 'samples'  : ['sm_mupVjj_ewk_dim6_EFT', 'sm_mumVjj_ewk_dim6_EFT', 'sm_emVjj_ewk_dim6_EFT', 'sm_epVjj_ewk_dim6_EFT', 'sm_tapVjj_ewk_dim6_EFT', 'sm_tamVjj_ewk_dim6_EFT'],
                 'fill': 1001
              }
...
# groupPlot['VBS_dipoleRecoil']  = {
#                  'nameHR' : 'VBS_dipoleRecoil',
#                  'isSignal' : 0,
#                  'color': palette["Pink"], #palette["Peach3"],  
#                  'samples'  : ['VBS_dipoleRecoil'],
#                  'fill': 1001
