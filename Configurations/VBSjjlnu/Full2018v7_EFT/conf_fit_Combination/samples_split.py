...
def nanoGetSampleFiles(inputDir, sample):
    return getSampleFiles(inputDir, sample, True, 'nanoLatino_', True)
...
samples['sm'] = {
   'name': nanoGetSampleFiles(directory_EFT,'tamVjj_ewk_dim6_EFT') + nanoGetSampleFiles(directory_EFT,'mupVjj_ewk_dim6_EFT') + nanoGetSampleFiles(directory_EFT,'epVjj_ewk_dim6_EFT'),
   'weight': SFweight+'*'+METFilter_MC+'*'+GenLepMatch+'*btagSF_corr_VBS_dipoleRecoil' + '*' + 'LHEWeight_originalXWGTUP',
   'FilesPerJob': 10,
}

samples['quad_cbHIm'] = {
   'name': nanoGetSampleFiles(directory_EFT,'tamVjj_ewk_dim6_EFT') + nanoGetSampleFiles(directory_EFT,'mupVjj_ewk_dim6_EFT') + nanoGetSampleFiles(directory_EFT,'epVjj_ewk_dim6_EFT'),
   'weight': SFweight+'*'+METFilter_MC+'*'+GenLepMatch+'*btagSF_corr_VBS_dipoleRecoil' + '*' + '0.5*(LHEReweightingWeight[11] + LHEReweightingWeight[12] - 2*LHEWeight_originalXWGTUP)',
   'FilesPerJob': 10,
}

samples['sm_lin_quad_cbHIm'] = {
   'name': nanoGetSampleFiles(directory_EFT,'tamVjj_ewk_dim6_EFT') + nanoGetSampleFiles(directory_EFT,'mupVjj_ewk_dim6_EFT') + nanoGetSampleFiles(directory_EFT,'epVjj_ewk_dim6_EFT'),
   'weight': SFweight+'*'+METFilter_MC+'*'+GenLepMatch+'*btagSF_corr_VBS_dipoleRecoil' + '*' + 'LHEReweightingWeight[11]',
   'FilesPerJob': 10,
}

samples['quad_cHB'] = {
   'name': nanoGetSampleFiles(directory_EFT,'tamVjj_ewk_dim6_EFT') + nanoGetSampleFiles(directory_EFT,'mupVjj_ewk_dim6_EFT') + nanoGetSampleFiles(directory_EFT,'epVjj_ewk_dim6_EFT'),
   'weight': SFweight+'*'+METFilter_MC+'*'+GenLepMatch+'*btagSF_corr_VBS_dipoleRecoil' + '*' + '0.5*(LHEReweightingWeight[50] + LHEReweightingWeight[51] - 2*LHEWeight_originalXWGTUP)',
   'FilesPerJob': 10,
}

samples['sm_lin_quad_cHB'] = {
   'name': nanoGetSampleFiles(directory_EFT,'tamVjj_ewk_dim6_EFT') + nanoGetSampleFiles(directory_EFT,'mupVjj_ewk_dim6_EFT') + nanoGetSampleFiles(directory_EFT,'epVjj_ewk_dim6_EFT'),
   'weight': SFweight+'*'+METFilter_MC+'*'+GenLepMatch+'*btagSF_corr_VBS_dipoleRecoil' + '*' + 'LHEReweightingWeight[50]',
   'FilesPerJob': 10,
}

samples['quad_cHbox'] = {
   'name': nanoGetSampleFiles(directory_EFT,'tamVjj_ewk_dim6_EFT') + nanoGetSampleFiles(directory_EFT,'mupVjj_ewk_dim6_EFT') + nanoGetSampleFiles(directory_EFT,'epVjj_ewk_dim6_EFT'),
   'weight': SFweight+'*'+METFilter_MC+'*'+GenLepMatch+'*btagSF_corr_VBS_dipoleRecoil' + '*' + '0.5*(LHEReweightingWeight[83] + LHEReweightingWeight[84] - 2*LHEWeight_originalXWGTUP)',
   'FilesPerJob': 10,
}

samples['sm_lin_quad_cHbox'] = {
   'name': nanoGetSampleFiles(directory_EFT,'tamVjj_ewk_dim6_EFT') + nanoGetSampleFiles(directory_EFT,'mupVjj_ewk_dim6_EFT') + nanoGetSampleFiles(directory_EFT,'epVjj_ewk_dim6_EFT'),
   'weight': SFweight+'*'+METFilter_MC+'*'+GenLepMatch+'*btagSF_corr_VBS_dipoleRecoil' + '*' + 'LHEReweightingWeight[83]',
   'FilesPerJob': 10,
}

samples['quad_cHbq'] = {
   'name': nanoGetSampleFiles(directory_EFT,'tamVjj_ewk_dim6_EFT') + nanoGetSampleFiles(directory_EFT,'mupVjj_ewk_dim6_EFT') + nanoGetSampleFiles(directory_EFT,'epVjj_ewk_dim6_EFT'),
   'weight': SFweight+'*'+METFilter_MC+'*'+GenLepMatch+'*btagSF_corr_VBS_dipoleRecoil' + '*' + '0.5*(LHEReweightingWeight[115] + LHEReweightingWeight[116] - 2*LHEWeight_originalXWGTUP)',
   'FilesPerJob': 10,
}

samples['sm_lin_quad_cHbq'] = {
   'name': nanoGetSampleFiles(directory_EFT,'tamVjj_ewk_dim6_EFT') + nanoGetSampleFiles(directory_EFT,'mupVjj_ewk_dim6_EFT') + nanoGetSampleFiles(directory_EFT,'epVjj_ewk_dim6_EFT'),
   'weight': SFweight+'*'+METFilter_MC+'*'+GenLepMatch+'*btagSF_corr_VBS_dipoleRecoil' + '*' + 'LHEReweightingWeight[115]',
   'FilesPerJob': 10,
}

samples['quad_cHDD'] = {
   'name': nanoGetSampleFiles(directory_EFT,'tamVjj_ewk_dim6_EFT') + nanoGetSampleFiles(directory_EFT,'mupVjj_ewk_dim6_EFT') + nanoGetSampleFiles(directory_EFT,'epVjj_ewk_dim6_EFT'),
   'weight': SFweight+'*'+METFilter_MC+'*'+GenLepMatch+'*btagSF_corr_VBS_dipoleRecoil' + '*' + '0.5*(LHEReweightingWeight[183] + LHEReweightingWeight[184] - 2*LHEWeight_originalXWGTUP)',
   'FilesPerJob': 10,
}

samples['sm_lin_quad_cHDD'] = {
   'name': nanoGetSampleFiles(directory_EFT,'tamVjj_ewk_dim6_EFT') + nanoGetSampleFiles(directory_EFT,'mupVjj_ewk_dim6_EFT') + nanoGetSampleFiles(directory_EFT,'epVjj_ewk_dim6_EFT'),
   'weight': SFweight+'*'+METFilter_MC+'*'+GenLepMatch+'*btagSF_corr_VBS_dipoleRecoil' + '*' + 'LHEReweightingWeight[183]',
   'FilesPerJob': 10,
}
