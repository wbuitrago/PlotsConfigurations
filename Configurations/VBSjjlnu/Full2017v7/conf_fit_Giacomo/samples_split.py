...
# just to check sigmal yield is equal to the split one
...
# samples = {   key:v for key,v in samples.items() if key in VBS_samples + ["VBS_dipoleRecoil"]}